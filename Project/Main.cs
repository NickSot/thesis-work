...
namespace Project
{
    public partial class Main : Form
    {
        ...
        private InputDataPreparator preparator;
        ...
        private double[][] normalizeInputData()
        {
            ...
            return this.preparator.changeInputData(rawData).prepareInputData();
        }
            ...
            string outputText = await Task.Run<string>(() =>
            {
                ...
                for (int i = 0; i < inputs.Length; i++)
                {
                    ...
                    this.txtOutput.Invoke(new Action(() => {
                        this.txtOutput.AppendText($"Rounded result: {Math.Round(value[0]).ToString()} - Actual expected value:{inputs[i][19]}\n");
                    }));
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            this.preparator = new InputDataPreparator(this.inputData);
        }
        ...
        private void btnCreateModel_Click(object sender, EventArgs e)
        {
            ...
            modelArchitecture.Prepend(19);
            modelArchitecture.Append(1);
        ...
        private async void btnOutputModelDetails_Click(object sender, EventArgs e)
        {
